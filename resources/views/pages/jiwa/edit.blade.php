      ...
      <div class="section-body">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form action="/dashboard/jiwa/{{ $jiwa->id }}" method="POST">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" required value="{{ $jiwa->nama }}">
                    @error('nama')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="alamat" name="alamat" required value="{{ $jiwa->alamat }}">
                    @error('alamat')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="status" name="status" required value="{{ $jiwa->status }}">
                    @error('status')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="umur" name="umur" required value="{{ $jiwa->umur }}">
                    @error('umur')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
