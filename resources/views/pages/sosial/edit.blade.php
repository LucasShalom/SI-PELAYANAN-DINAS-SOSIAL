      ...
      <div class="section-body">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form action="/dashboard/sosial/{{ $sosial->id }}" method="POST">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" required value="{{ $sosial->nama }}">
                    @error('nama')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="alamat" name="alamat" required value="{{ $sosial->alamat }}">
                    @error('alamat')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="status" name="status" required value="{{ $sosial->status }}">
                    @error('status')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="umur" name="umur" required value="{{ $sosial->umur }}">
                    @error('umur')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
