                ...
                <form action="/dashboard/customer/{{ $customer->id }}" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <select name="staffadministrasi_id" required class="form-control">
                      ...
                      @if ($item->staffadministrasi_id == $customer->id)
                      <option value="{{ $item->id }}" selected>{{ $item->DATA_MASUK }}</option>
                      @else
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="JENIS_KASUS" name="JENIS_KASUS" required value="{{ $customer->JENIS_KASUS }}">
                    @error('JENIS_KASUS')
