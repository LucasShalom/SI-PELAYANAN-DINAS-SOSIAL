      ...
      <div class="section-body">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form action="/dashboard/staffadmin" method="POST">
                  @csrf
                  <div class="form-group">
                    <label for="DATA_MASUK">DATA MASUK</label>
                    <input type="date" class="form-control" id="DATA_MASUK" name="DATA_MASUK" value="" required>
                    @error('DATA_MASUK')
                    <p class="text-danger">
                      {{ $message }}
                    </p>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="DATA_KELUAR" name="DATA_KELUAR" value="" required>
                    @error('DATA_KELUAR')
                    <p class="text-danger">
                      {{ $message }}
                    </p>
